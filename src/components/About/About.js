...
const About = () => {
    ...
    return (
        <StyleAbout id="about">
            <motion.h2 variants={rightAnimate} initial="start" whileInView="end" viewport={{ once: true, amount: 0.8 }}>I am <span className='low-highlight'>passionate on creating websites</span> that is pleasing to the eyes of the user.</motion.h2>
            <AboutContent className='about-content'>
                ...
                <div>
                    <AboutPersonal variants={aboutPara1} initial="start" whileInView="end" viewport={{ once: true, amount: 0.8 }} className='personal'>
                        <p>
